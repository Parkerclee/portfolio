...
initials: BL
title: "Designing a Company Onboarding Course for a Global Media-Tech Firm"
challenge: "BENlabs was growing through acquisition and needed a single onboarding experience that could orient new hires across business units — from AI researchers to entertainment brand strategists — without talking down to either group."
deliverable: "Rise 360 onboarding course + LMS deployment"
duration: "~8 months"
...
tools:
  ...
  - Bynder (DAM)
  - Bridge LMS
demoLink: "https://rise.articulate.com/share/8OcqI_Nn26Kb77XVlLxnC6f97nH8nAfU"
draft: false
aiGenerated: false
---
...
1. **Who we are** — company history, evolution from BE ON to BENlabs, the acquisition story told honestly
2. **What we do** — the product suite, client categories, how the AI layer works without requiring a data science background
3. **How we work** — tools, norms, cross-team operating agreements, communication expectations
4. **Your role in it** — closing reflection that ties individual work back to company mission
...
**[View the BENlabs onboarding course →](https://rise.articulate.com/share/8OcqI_Nn26Kb77XVlLxnC6f97nH8nAfU)**
